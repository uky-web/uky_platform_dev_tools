...
/**
 * UK Project Template database configuration.
 *
 * This database configuration is included as part of the
 * UK Drupal Project Template. It loads database connection
